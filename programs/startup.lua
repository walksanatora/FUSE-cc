...
_ = periphemu and periphemu.remove("top")
...
--shell.setPath(shell.path()..":/FUSE/programs:/FUSE-vfs")
shell.setPath(shell.path()..":/yellowbox-fork")

--shell.run("mvfs mount virt vm.vfs")
